...
if (typeof document !== 'undefined' && !document.querySelector('#reject-request-modal-styles')) {
    const styleSheet = document.createElement('style')
    styleSheet.id = 'reject-request-modal-styles'
    styleSheet.textContent = popupStyles
    document.head.appendChild(styleSheet)
}

const RejectRequestModal = ({ isOpen, onClose, onSubmit, requestTitle }) => {
                ...
                <div className="px-6 py-4 border-b border-slate-200 flex items-center justify-between bg-gradient-to-r from-red-50 to-orange-50">
                    <div>
                        ...
                        <p className="text-sm text-slate-600 mt-1">
                            {requestTitle ? `Yêu cầu: ${requestTitle}` : 'Vui lòng nhập lý do từ chối yêu cầu này'}
                        </p>
                    </div>
                    <button
                        onClick={handleClose}
                ...
                <form onSubmit={handleSubmit} className="p-6 bg-slate-50/30">
                    <div className="mb-4">
                        ...
                        <textarea
                            ...
                            placeholder="Vui lòng nhập lý do từ chối yêu cầu này (tối thiểu 10 ký tự)..."
                        />
                        {errors.reason && (
