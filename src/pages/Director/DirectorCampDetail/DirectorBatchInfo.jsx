...
const DirectorBatchInfo = ({ campaign }) => {
    ...
    const [currentBatches, setCurrentBatches] = useState(() => {
        ...
        if (campaign?.rounds && Array.isArray(campaign.rounds) && campaign.rounds.length > 0) {
            console.log('DirectorBatchInfo: Found rounds in campaign:', campaign.rounds)
        ...
        if (Array.isArray(campaign?.batches) && campaign.batches.length > 0) {
            console.log('DirectorBatchInfo: Found batches in campaign:', campaign.batches)
    ...
    useEffect(() => {
        ...
        if (campaign?.rounds && Array.isArray(campaign.rounds)) {
            console.log('DirectorBatchInfo: Updating batches from rounds:', campaign.rounds)
            ...
            console.log('DirectorBatchInfo: Updating batches from batches array:', campaign.batches)
