...
const ExaminerPromotionDetailPage = () => {
  const { id } = useParams();
                    ...
                    <div key={item.label} className="bg-gray-50 rounded-lg p-4">
                      ...
                      <dd
                        className={`text-base font-semibold mt-1 ${
                          item.isBadge ? "inline-block" : "text-gray-900"
                        }`}
                      >
                        {item.isBadge ? (
                          <span
                          ...
                          <span className={item.valueClass || "text-gray-900"}>
                            {item.value || "—"}
                          </span>
                        )}
                      </dd>
                          ...
                          <table className="min-w-full divide-y divide-gray-200 table-fixed">
                            <thead className="bg-gray-50">
                              <tr>
                                <th
                                  scope="col"
                                  className="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider w-[50%]"
                                >
                                  Criteria
                                </th>
                                <th
                                ...
                                <th
                                  scope="col"
                                  className="px-4 py-3 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider w-[35%]"
                                >
                                  Comment
                                </th>
                              </tr>
...
export default ExaminerPromotionDetailPage;
