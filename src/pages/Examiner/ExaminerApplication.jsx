...
const ExaminerApplication = () => {
    ...
    useEffect(() => {
        ...
        const fetchCandidate = async () => {
            ...
            if (!applicationId) {
                setError('Application ID not found. Please go back to the list and try again.')
        ...
        return (
            <div className="flex items-center justify-center min-h-screen">
                <div className="text-center">
                    <h2 className="text-2xl font-bold text-slate-800 mb-4">Candidate information not found</h2>
                    {error && (
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-800 bg-slate-50 p-3 rounded-md">{candidate.gender === 'male' ? 'Male' : candidate.gender === 'female' ? 'Female' : '—'}</p>
                                    </div>
...
export default ExaminerApplication