...
const mockEnglishTests = [
    ...
    },
    {
        ...
        description: 'Đề thi đánh giá trình độ tiếng Anh nâng cao cho ứng viên có kinh nghiệm',
        level: 'Nâng cao',
        duration: 90,
        totalQuestions: 10,
    ...
    },
    {
        ...
        description: 'Đề thi chuyên biệt về tiếng Anh giao tiếp trong ngành hàng không',
        level: 'Chuyên ngành',
        duration: 75,
        totalQuestions: 15,
...
const TestingPage = () => {
    ...
    const handleCreateTest = () => {
        ...
        alert('Chức năng tạo đề thi mới sẽ được triển khai')
    }
    ...
    return (
        <div className="p-6">
            ...
            <div className="mb-6 flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-bold text-slate-800 mb-2">Quản lý đề thi tiếng Anh</h2>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200">
                {filteredTests.length === 0 ? (
                    <div className="p-12 text-center">
                        ...
                        <p className="text-slate-600 text-lg font-medium mb-2">Không tìm thấy đề thi nào</p>
                        <p className="text-slate-500 text-sm">Thử thay đổi bộ lọc hoặc tạo đề thi mới</p>
                    </div>
                ) : (
                    <div className="divide-y divide-slate-200">
                        {filteredTests.map((test) => (
                            <div key={test.id} className="p-5 hover:bg-slate-50 transition-colors">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                            ...
                                            <div>
                                                ...
                                                <span className="ml-2 font-medium text-slate-800">{test.usageCount} lần</span>
                                            </div>
                                        </div>
