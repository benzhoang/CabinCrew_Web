...
import { getConfigurationById, updateConfiguration } from "../../../service/api2";
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const updateData = {
                ...
                roundConfigurationId: configData.roundConfigurationId || configData.id || 0,
                campaignType: typeof configData.campaignType === 'string'
                    ? parseInt(configData.campaignType, 10)
                    : (configData.campaignType || 0),
                configurationType: typeof configData.configurationType === 'string'
            ...
            if (result.success) {
                ...
                toast.error(result.error || "Cannot update configuration");
            }
        } catch (err) {
            ...
            <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl p-6 space-y-4">
                ...
                {isLoading ? (
                    <div className="flex items-center justify-center py-8">
                        ...
                        <p className="ml-3 text-sm text-gray-600">Loading configuration...</p>
                    </div>
                ) : (
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full rounded-lg border bg-white px-3 py-2 text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 ${error ? "border-red-500" : "border-slate-300"
                                    }`}
                                disabled={isSubmitting || isLoading}
                                required
                            />
