  ...
  const groups = useMemo(() => {
    ...
    const mapped = (data || [])
      .map((group) => ({
        ...
        items:
          group.items || group.interviewCriteriaItems || group.children || [],
      }))
            ...
            <div key={group.id} className="p-6 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  onClick={() => {
                    // Recruitment: id 1 cho group đầu, id 2 cho group thứ 2
                    const criteriaId = index === 0 ? 1 : 2;
              ...
              <div className="space-y-4">
                {group.items.map((item) => (
                  <div
                    key={`${group.id}-${
                      item.id || item.interviewCriteriaItemId || item.text
                    }`}
        ...
        onConfirm={async () => {
          ...
          try {
            ...
            if (result.success) {
              ...
              console.error(
                result.error || "Cannot delete interview criteria item"
              );
            }
          } catch (error) {
