...
const SeniorCandidateDetailPage = () => {
  ...
  useEffect(() => {
    ...
    if (stateCandidate) {
      ...
      const normalized = {
        ...
        mobileNumber:
          stateCandidate.mobileNumber ?? stateCandidate.phone ?? "N/A",
        ...
        certificateExpireDate:
          stateCandidate.certificateExpireDate ?? "2025-12-31",
        ...
        appliedDate:
          stateCandidate.applicationDate ?? stateCandidate.appliedDate ?? "",
        currentRound:
          stateCandidate.stage ?? stateCandidate.currentRound ?? "screening",
      ...
      <div className="bg-gradient-to-r from-indigo-500 to-blue-600">
        <div className="px-6 py-8 mx-auto max-w-7xl">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={goBack}
              className="px-5 py-2 text-white transition-colors border rounded-lg bg-white/20 hover:bg-white/30 border-white/30"
            >
              Back
            </button>
          </div>
                  ...
                  {rounds.map((r, idx) => {
                    ...
                    return (
                      <div key={r.key} className="flex flex-col items-center">
                        <div
                          className={`w-12 h-12 ${circleClass} rounded-full flex items-center justify-center mb-2 relative z-10`}
                        >
                          {icon}
                        </div>
                        <span
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 bg-white border border-gray-200 rounded-xl">
              ...
              <div className="mb-6 text-center">
                <div className="w-32 h-40 mx-auto mb-4 overflow-hidden border-2 rounded-lg shadow-sm bg-slate-100 border-slate-300">
                  <img
                    ...
                    onError={(e) => {
                      e.target.src =
                        "https://via.placeholder.com/128x160/cccccc/666666?text=Profile+Photo";
                    }}
                  />
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div className="p-3 rounded-lg bg-slate-50">
                  <div className="mb-1 text-xs text-slate-600">Phone</div>
                  <div className="text-sm font-medium text-slate-800">
                    {candidate.mobileNumber}
                  </div>
                </div>
                <div className="p-3 rounded-lg bg-slate-50">
                  <div className="mb-1 text-xs text-slate-600">Nationality</div>
                  <div className="text-sm font-medium text-slate-800">
                    {getNationalityText(candidate.nationality)}
                  </div>
                </div>
                <div className="p-3 rounded-lg bg-slate-50">
                  <div className="mb-1 text-xs text-slate-600">Experience</div>
                  <div className="text-sm font-medium text-slate-800">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="p-3 rounded-md text-slate-800 bg-slate-50">
                      {getNationalityText(candidate.nationality) || "N/A"}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="p-3 rounded-md text-slate-800 bg-slate-50">
                      {formatDate(candidate.dateOfBirth) || "N/A"}
                    </p>
                  </div>
                  ...
                  <div>
                    <label className="block mb-1 text-sm font-medium text-slate-700">
                      7a. Flight Experience:
                    </label>
                    <p className="p-3 rounded-md text-slate-800 bg-slate-50">
                      {candidate.flightExperience || "N/A"}
                    </p>
                  </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="p-3 rounded-md text-slate-800 bg-slate-50">
                      {candidate.englishCertificate || "N/A"}
                    </p>
                  </div>
                  <div>
                    <label className="block mb-1 text-sm font-medium text-slate-700">
                    ...
                    <p className="p-3 rounded-md text-slate-800 bg-slate-50">
                      {formatDate(candidate.certificateExpireDate) || "N/A"}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div>
                  ...
                  <p className="p-3 rounded-md text-slate-800 bg-slate-50">
                    {getBasePreferenceText(candidate.basePreference) || "N/A"}
                  </p>
                </div>
              </div>
            </div>
...
export default SeniorCandidateDetailPage;
