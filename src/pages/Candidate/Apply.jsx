...
const getAxisPercent = (index, total) => {
    if (total <= 1) return LINE_START_PERCENT;
    return LINE_START_PERCENT + ((LINE_END_PERCENT - LINE_START_PERCENT) * (index / (total - 1)));
};
...
// Helper function to check if a round type is English test (either listening or speaking)
const isEnglishTest = (roundTypeName) => {
    return isEnglishListening(roundTypeName) || isEnglishSpeaking(roundTypeName);
};
                                ...
                                <div className="mt-6">
                                    ...
                                    <div className="bg-purple-50 border border-purple-300 rounded-lg p-4">
                                        {isLoadingRoundTypes ? (
                                                        ...
                                                        <>
                                                            ...
                                                            {roundTypes.map((roundType, index) => {
                                                                ...
                                                                if (isEnglishTestStage) {
                                                                    ...
                                                                    const verticalOffset = isListening ? -BRANCH_OFFSET : BRANCH_OFFSET;
                                                                    positionStyle = {
                                                                        left: `${axisPercent}%`,
                                            ...
                                            <div className="text-center py-8">
                                                <p className="text-sm text-slate-500">No process information available</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
