    ...
    try {
      ...
      if (result.success) {
        ...
        if (
          ...
          responseData &&
          typeof responseData.correctAnswers === "number"
        ) {
        ...
        if (wrongAnswers === 0 && responseData) {
          wrongAnswers =
            (responseData.submittedAnswers?.length || answersArray.length) -
            correctAnswers;
        }
        ...
        toast.dismiss();
        const errorMessage =
          result.error || "Không thể nộp bài. Vui lòng thử lại.";
