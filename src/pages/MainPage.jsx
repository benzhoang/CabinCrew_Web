            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
                <div className="w-full max-w-md">
                    ...
                    <div className="text-center mb-8">
                        ...
                        />
                        <h1 className="text-2xl font-bold text-gray-800 mb-2">SkyCabin Airlines</h1>
                        <p className="text-gray-600">Hệ thống tuyển dụng và nâng bậc nhân viên hàng không</p>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                        ...
                        <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
                            <h2 className="text-xl font-bold text-white text-center">Đăng nhập hệ thống</h2>
                        </div>

                        {/* Content */}
                        <div className="p-8">
                            <div className="mb-6">
                                <p className="text-gray-600 text-center">Nhập thông tin đăng nhập để truy cập hệ thống</p>
                            </div>
