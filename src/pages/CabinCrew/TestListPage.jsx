...
const mockExams = [
    {
        id: 1,
        name: 'Bài kiểm tra thăng bậc lên Senior Flight Attendant',
        code: 'PROM001',
        duration: 30, // phút
        totalQuestions: 15,
    ...
    {
        id: 2,
        name: 'Bài kiểm tra thăng bậc lên Purser',
        code: 'PROM002',
        duration: 45,
        totalQuestions: 20,
    ...
    {
        id: 3,
        name: 'Bài kiểm tra năng lực lãnh đạo và quản lý đội ngũ',
        code: 'PROM003',
        duration: 25,
        totalQuestions: 10,
    ...
    {
        id: 4,
        name: 'Bài kiểm tra kỹ năng xử lý tình huống khẩn cấp nâng cao',
        code: 'PROM004',
        duration: 25,
        totalQuestions: 10,
        description: 'Bài thi đánh giá kỹ năng giao tiếp và xử lý tình huống'
...
const TestListPage = () => {
    ...
    const handleSubmit = async (examId) => {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                navigate(`/cabin-crew/tests/${expandedExamId}`);
            }, 1500);
        }, 1000);
    };
