...
const SearchableDropdown = ({
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute z-50 w-full mt-1 overflow-hidden bg-white border border-gray-300 rounded-lg shadow-lg max-h-60">
            ...
            <div className="sticky p-6 bg-white shadow-lg rounded-xl top-8">
              ...
              <div className="mb-8 text-center">
                <div className="relative inline-block">
                  <div className="w-32 h-32 mx-auto overflow-hidden bg-gray-200 border-4 border-white rounded-full shadow-lg">
                    {formData.avatar ? (
                      <img
                        src={formData.avatar}
                        alt="Avatar"
