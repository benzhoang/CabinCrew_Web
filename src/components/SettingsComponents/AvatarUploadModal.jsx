            ...
            if (result.success) {
                ...
                if (result.data) {
                    ...
                    if (typeof result.data === 'string') {
                        ...
                        imageUrl = result.data.imgURL || result.data.url || result.data.imageUrl || result.data.imagePath || result.data.path;
                    }
                ...
                const errorMessage = result.error || 'Tải ảnh đại diện thất bại. Vui lòng thử lại.';
                setError(errorMessage);
                toast.error(errorMessage);
            }
        } catch (error) {
            const errorMessage = error.message || 'Đã xảy ra lỗi khi tải ảnh. Vui lòng thử lại.';
            setError(errorMessage);
            toast.error(errorMessage);
        } finally {
    ...
    const modalContent = (
        ...
        >
            ...
            >
                ...
                {/* Preview Area */}
                <div className="mb-6">
                    <div className="w-48 h-48 mx-auto rounded-full overflow-hidden bg-gray-200 border-4 border-gray-300">
                        {preview ? (
                            <img
                                src={preview}
                                alt="Preview"
                ...
                <div className="mb-6">
                    <label
                        ...
                        className="block w-full px-4 py-3 text-center text-white bg-blue-600 rounded-lg cursor-pointer hover:bg-blue-700 transition-colors"
                    >
                ...
                <div className="flex space-x-3">
                    ...
                    <button
                        ...
                        className={`flex-1 px-4 py-2 text-white rounded-lg transition-colors flex items-center justify-center ${selectedFile && !isUploading
